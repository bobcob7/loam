 ...
 * Wrapped in `AppProviders` (the same composition `App.tsx` uses) because a
 * routed screen is free to call `useQuery`/`useMutation` -- the Jobs screen
 * does (loam-nvb.14) -- and those throw synchronously without a
