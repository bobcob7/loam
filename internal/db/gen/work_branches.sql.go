...
const demoteWorkBranchOnConflict = `-- name: DemoteWorkBranchOnConflict :one
UPDATE work_branches
...
func (q *Queries) DemoteWorkBranchOnConflict(ctx context.Context, id pgtype.UUID) (WorkBranch, error) {
	row := q.db.QueryRow(ctx, demoteWorkBranchOnConflict, id)
	var i WorkBranch
	err := row.Scan(
		&i.ID,
		&i.RepoID,
...
const flagWorkBranchConflict = `-- name: FlagWorkBranchConflict :one
UPDATE work_branches
...
func (q *Queries) FlagWorkBranchConflict(ctx context.Context, id pgtype.UUID) (WorkBranch, error) {
	row := q.db.QueryRow(ctx, flagWorkBranchConflict, id)
	var i WorkBranch
	err := row.Scan(
		&i.ID,
		&i.RepoID,
