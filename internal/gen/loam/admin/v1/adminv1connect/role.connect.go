...
const (
	...
	RoleServiceName = "loam.admin.v1.RoleService"
)
...
const (
	...
	RoleServiceListRolesProcedure = "/loam.admin.v1.RoleService/ListRoles"
	// RoleServiceGetRoleProcedure is the fully-qualified name of the RoleService's GetRole RPC.
	RoleServiceGetRoleProcedure = "/loam.admin.v1.RoleService/GetRole"
	// RoleServiceCreateRoleProcedure is the fully-qualified name of the RoleService's CreateRole RPC.
	RoleServiceCreateRoleProcedure = "/loam.admin.v1.RoleService/CreateRole"
	// RoleServiceUpdateRoleProcedure is the fully-qualified name of the RoleService's UpdateRole RPC.
	RoleServiceUpdateRoleProcedure = "/loam.admin.v1.RoleService/UpdateRole"
	// RoleServiceDeleteRoleProcedure is the fully-qualified name of the RoleService's DeleteRole RPC.
	RoleServiceDeleteRoleProcedure = "/loam.admin.v1.RoleService/DeleteRole"
)

// RoleServiceClient is a client for the loam.admin.v1.RoleService service.
...
// NewRoleServiceClient constructs a client for the loam.admin.v1.RoleService service. By default,
...
func NewRoleServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) RoleServiceClient {
	...
	roleServiceMethods := v1.File_loam_admin_v1_role_proto.Services().ByName("RoleService").Methods()
...
// ListRoles calls loam.admin.v1.RoleService.ListRoles.
...
// GetRole calls loam.admin.v1.RoleService.GetRole.
...
// CreateRole calls loam.admin.v1.RoleService.CreateRole.
...
// UpdateRole calls loam.admin.v1.RoleService.UpdateRole.
...
// DeleteRole calls loam.admin.v1.RoleService.DeleteRole.
...
// RoleServiceHandler is an implementation of the loam.admin.v1.RoleService service.
...
func NewRoleServiceHandler(svc RoleServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/loam.admin.v1.RoleService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedRoleServiceHandler) ListRoles(context.Context, *connect.Request[v1.ListRolesRequest]) (*connect.Response[v1.ListRolesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("loam.admin.v1.RoleService.ListRoles is not implemented"))
}
...
func (UnimplementedRoleServiceHandler) GetRole(context.Context, *connect.Request[v1.GetRoleRequest]) (*connect.Response[v1.GetRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("loam.admin.v1.RoleService.GetRole is not implemented"))
}
...
func (UnimplementedRoleServiceHandler) CreateRole(context.Context, *connect.Request[v1.CreateRoleRequest]) (*connect.Response[v1.CreateRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("loam.admin.v1.RoleService.CreateRole is not implemented"))
}
...
func (UnimplementedRoleServiceHandler) UpdateRole(context.Context, *connect.Request[v1.UpdateRoleRequest]) (*connect.Response[v1.UpdateRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("loam.admin.v1.RoleService.UpdateRole is not implemented"))
}
...
func (UnimplementedRoleServiceHandler) DeleteRole(context.Context, *connect.Request[v1.DeleteRoleRequest]) (*connect.Response[v1.DeleteRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("loam.admin.v1.RoleService.DeleteRole is not implemented"))
}
